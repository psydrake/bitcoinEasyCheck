...
public class bitcoinEasyCheck extends CordovaActivity {
	...
	private final static String ADMOB_AD_UNIT = "XX-XXX-XXX-XXXXXXXXXXXXXXXX/XXXXXXXXXX";
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		/* Let's throw a bone to loyal-to-the-death Blackberry users and not give 'em ads
        // Google AdMob
